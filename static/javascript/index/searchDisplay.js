function searchBtnClicked() {
    ...
    if (!(elem.classList.contains("nav__details__search-mobile"))) {
        ...
        menuB.classList.remove("nav__details__btn-mobile-pic");
        menuB.classList.add("nav__details__btn-mobile-hidden");
        ...
        menuB.classList.add("nav__details__btn-mobile-pic");
        menuB.classList.remove("nav__details__btn-mobile-hidden");
    }
}